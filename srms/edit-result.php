...
<html lang="en">
    <head>
        ...
        <title>SGBIT Teacher|  Student result info < </title>
...
$ret = "SELECT tblstudents.StudentName,tblclasses.Sem,tblclasses.Section from tblresult join tblstudents on tblresult.StudentId=tblresult.StudentId join tblsubjects on tblsubjects.id=tblresult.SubjectId join tblclasses on tblclasses.id=tblstudents.ClassId where tblstudents.StudentId=:stid limit 1";
...
{  ?>
                                            ...
                                            <label for="default" class="col-sm-2 control-label">Sem</label>
                                                        <div class="col-sm-10">
<?php echo htmlentities($row->Sem)?>(<?php echo htmlentities($row->Section)?>)
                                                        </div>
                                                    </div>
<div class="form-group">
