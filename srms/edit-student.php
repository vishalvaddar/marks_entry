...
$dob=$_POST['dob']; 
$status=$_POST['status'];
$sql="update tblstudents set StudentName=:studentname,USN=:roolid,StudentEmail=:studentemail,Gender=:gender,DOB=:dob,Status=:status where StudentId=:stid ";
...
<html lang="en">
    <head>
        ...
        <title>SGBIT Teacher| Edit Student < </title>
...
$sql = "SELECT tblstudents.StudentName,tblstudents.USN,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status,tblstudents.StudentEmail,tblstudents.Gender,tblstudents.DOB,tblclasses.Sem,tblclasses.Section from tblstudents join tblclasses on tblclasses.id=tblstudents.ClassId where tblstudents.StudentId=:stid";
$query = $dbh->prepare($sql);
$query->bindParam(':stid',$stid,PDO::PARAM_STR);
$query->execute();
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="text" name="USN" class="form-control" id="USN" value="<?php echo htmlentities($result->USN)?>" maxlength="10" required="required" autocomplete="off">
    </div>
</div>
...
<?php }?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
<input type="text" name="classname" class="form-control" id="classname" value="<?php echo htmlentities($result->Sem)?>(<?php echo htmlentities($result->Section)?>)" readonly>
                                                        </div>
                                                    </div>
<div class="form-group">
